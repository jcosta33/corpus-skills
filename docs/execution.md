...
From [`write-research`](https://github.com/jcosta33/corpus-starter-kit/blob/main/.agents/skills/write-research/SKILL.md) (starter kit): every `R-NNN` finding carries a non-empty
...
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------- |
| [`write-spec`](https://github.com/jcosta33/corpus-starter-kit/blob/main/.agents/skills/write-spec/SKILL.md) (starter kit)             | Every requirement carries a `Verify with:` line; the open-question list is output before delivery.                                                                                               | Open-spec questions slipping into implementation.                                           |
| [`write-audit`](https://github.com/jcosta33/corpus-starter-kit/blob/main/.agents/skills/write-audit/SKILL.md) (starter kit)           | Every observation cites `path:line` or pasted output, carries a severity, and every risk names its firing condition — the Before-you-finish checklist holds the audit until each box is checked. | Findings that are observations dressed up as actions, with no anchor in the code.           |
| [`write-bug-report`](https://github.com/jcosta33/corpus-starter-kit/blob/main/.agents/skills/write-bug-report/SKILL.md) (starter kit) | The failing reproduction output is pasted verbatim before the report is final.                                                                                                                   | Bug reports asserting "the bug fires" without proof.                                        |
